...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "Schönes-Wochenende-Ticket", "b": true}, {"t": "• gültig ab Samstag 0 Uhr bis Montag 3 Uhr für Reisen in Deutschland", "b": false}, {"t": "• für Gruppen bis zu fünf Personen und für Einzelreisende", "b": false}, {"t": "Preis: 39 Euro im Internet, 41 Euro im Reisezentrum an Ihrem Bahnhof", "b": false}, {"t": "www.bahn.de/angebote", "b": false}]}, {"paragraphs": [{"t": "Lesen im Park", "b": true}, {"t": "Im Sommer gibt es in Grazer Parks wieder Bücherkisten mit vielen Kinderbüchern – zum Lesen vor Ort oder zum Mit-nach-Hause-Nehmen.", "b": false}, {"t": "Weitere Aktivitäten: Bastel- und Malgruppen; Papier und Stifte haben wir für dich.", "b": false}, {"t": "www.lesen-im-park.at", "b": false}]}, {"paragraphs": [{"t": "3-Zimmer-Wohnung", "b": true}, {"t": "Neu renovierte Wohnung (63 m²) ab 1. August zu vermieten", "b": false}, {"t": "Gesamtmiete: CHF 1.200,–", "b": false}, {"t": "Sie haben noch Fragen? Schreiben Sie eine E-Mail an: info@immobilien-heiss.ch", "b": false}, {"t": "Termine zur Wohnungsbesichtigung: 15. Juli, 11.00 Uhr | 18. Juli, 15.00 Uhr", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
    ...
    ('hv1', 'Hören', 'Hören, Teil 1', 4, 'Sie hören fünf verschiedene Texte zu den Fotos. Welcher Text passt zu welchem Foto? Ein Bild ist zu viel.', 'matching', '{"bank": [{"key": "A", "text": "Foto A"}, {"key": "B", "text": "Foto B"}, {"key": "C", "text": "Foto C"}, {"key": "D", "text": "Foto D"}, {"key": "E", "text": "Foto E"}, {"key": "F", "text": "Foto F"}], "bankTitle": "Fotos", "bankImage": "img/oesd-a1-m01-hv1.jpg", "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 2, "audio": "oesd-a1-m01-hv1.mp3", "audioPlays": 2}'::jsonb, 3),
    ('hv2', 'Hören', 'Hören, Teil 2 (Telefonnotiz)', 3, 'Sie hören eine Nachricht. Hören Sie gut zu und schreiben Sie die wichtigsten Informationen auf das Notizblatt. Sie hören den Text zwei Mal.', 'writing', '{"passages": [{"paragraphs": [{"t": "Notizen: Auto ansehen", "b": true}, {"t": "Was: Auto ansehen (Beispiel)", "b": false}, {"t": "Wann: am ............................, am Nachmittag, ............................ Mai, um ............................ Uhr", "b": false}, {"t": "Wo: in der ............................gasse 12", "b": false}, {"t": "Telefonnummer: 0664 / ............................", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 10, "audio": "oesd-a1-m01-hv2.mp3", "audioPlays": 2}'::jsonb, 4),
    ('hv3', 'Hören', 'Hören, Teil 3', 3, 'Sie hören jetzt 5 Personen, die befragt werden: „Wo gefällt es Ihnen am besten?“ Kreuzen Sie die richtige Antwort an. Pro Person gibt es nur eine Antwort.', 'mc', '{"maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 2, "audio": "oesd-a1-m01-hv3.mp3", "audioPlays": 2}'::jsonb, 5),
...
from (values
    ...
    ('lv2', '7', 'Kostet das Ticket beim Kauf am Bahnhof mehr?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Darf man die Bücher nur im Park lesen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Müssen die Kinder Papier und Stifte mitbringen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "Damen-Friseursalon Helga", "b": true}, {"t": "Neue Öffnungszeiten:", "b": false}, {"t": "Di.–Do. 11–18 Uhr", "b": false}, {"t": "Fr. 15–20 Uhr", "b": false}, {"t": "Sa. 10–14 Uhr", "b": false}, {"t": "Haare waschen – schneiden – färben – Dauerwelle", "b": false}, {"t": "Aktion für Studentinnen: minus 50 Prozent!", "b": false}]}, {"paragraphs": [{"t": "Weltcafé", "b": true}, {"t": "Vegetarische Küche", "b": false}, {"t": "Mittagsmenü (Suppe und Hauptspeise) für 5,80 Euro", "b": false}, {"t": "Überdachter Gastgarten!", "b": false}, {"t": "NEU jeden Freitag:", "b": false}, {"t": "Essen mit Musik von 18:00 bis 23:00 Uhr, nur mit Reservierung", "b": false}]}, {"paragraphs": [{"t": "HAUPTBAHNHOF NEU", "b": true}, {"t": "Wir bauen für Sie!", "b": false}, {"t": "Der Haupteingang am Rudolfsplatz ist bis Dezember geschlossen. Bitte nehmen Sie den Eingang in der Bahnhofstraße.", "b": false}, {"t": "Die Schalter für Fahrkarten und die Information haben ganz normal für Sie geöffnet.", "b": false}, {"t": "Wir danken für Ihr Verständnis!", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
...
from (values
    ...
    ('lv2', '7', 'Zahlen Studentinnen den halben Preis?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Gibt es im Weltcafé Hauptspeisen ohne Fleisch?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Muss man am Freitagabend reservieren?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "Sprachkurse an der SPRACHSCHULE OLYMP", "b": true}, {"t": "Wir bieten Kurse für folgende Sprachen:", "b": false}, {"t": "Deutsch, Englisch, Französisch, Russisch, Slowenisch, Türkisch, Polnisch, Tschechisch und Slowakisch", "b": false}, {"t": "Kurse: Dienstag und Donnerstag, 13 bis 16 Uhr", "b": false}, {"t": "Sprachschule Olymp", "b": false}, {"t": "Oberbergerstraße 17 | Tel: 01 313 56 72", "b": false}]}, {"paragraphs": [{"t": "Tiere suchen ein Zuhause", "b": true}, {"t": "über 500 Tiere im neuen Tierschutzzentrum in Wien-Donaustadt", "b": false}, {"t": "Besuchen Sie uns:", "b": false}, {"t": "Di und Do: 15 bis 17 Uhr", "b": false}, {"t": "Fr und Sa: 13 bis 17 Uhr", "b": false}, {"t": "Informationen und Kontakt: 01 277 55", "b": false}, {"t": "www.tierquartier.at", "b": false}]}, {"paragraphs": [{"t": "Spezialkurs: Schreiben IM ALLTAG", "b": true}, {"t": "Hier lernen Sie, wie man z. B.:", "b": false}, {"t": "✓ ein Formular ausfüllt,", "b": false}, {"t": "✓ einen kurzen Brief oder", "b": false}, {"t": "✓ eine Entschuldigung für das kranke Kind in der Schule schreibt.", "b": false}, {"t": "Volkshochschule Süd, Raum 3", "b": false}, {"t": "10 Abende je 2 Stunden ab Montag, 17–19 Uhr", "b": false}, {"t": "Tel. Anmeldung unter 01 45 67 988", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
...
from (values
    ...
    ('lv2', '7', 'Gibt es am Mittwochnachmittag Kurse?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Kann man jeden Tag ins Tierschutzzentrum gehen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Kann man im Tierschutzzentrum anrufen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "Treffen Sie Menschen aus der ganzen Welt!", "b": true}, {"t": "Sie lernen neue Freunde kennen, kochen gemeinsam und hören etwas über andere Länder!", "b": false}, {"t": "Wann: jeden Freitag ab 18.00 Uhr", "b": false}, {"t": "Clubcafé im Amtshaus", "b": false}, {"t": "Goethestraße 3", "b": false}, {"t": "Tel: 0664 / 5763 45 32", "b": false}]}, {"paragraphs": [{"t": "D-A-CH Bands laden zur MUSIK-NACHT", "b": true}, {"t": "am Freitag, 7. Juli, Beginn 19 Uhr", "b": false}, {"t": "Musik aus Deutschland, Österreich und der Schweiz!", "b": false}, {"t": "Buffet mit regionalen Speisen aus allen drei Ländern", "b": false}, {"t": "DACH-Zentrum | Saal 3, 1. Stock", "b": false}, {"t": "Eintritt: 6 Euro", "b": false}]}, {"paragraphs": [{"t": "FLOTT Transport", "b": true}, {"t": "Neue Wohnung, aber kein großes Auto?", "b": false}, {"t": "Wir bringen Ihre Möbel und vieles mehr an jeden Ort – in Österreich und Europa.", "b": false}, {"t": "2 Männer + Auto: 40 Euro pro Stunde", "b": false}, {"t": "24-Stunden-Hotline: +43 (0) 660 21 24 459", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
...
from (values
    ...
    ('lv2', '7', 'Kann man nächsten Donnerstag ins Clubcafé kommen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Gibt es etwas zu essen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Muss man für das Fest bezahlen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "Achtung!", "b": true}, {"t": "Ihr Deutschkurs fängt erst nächste Woche an. Die Trainerin ist krank.", "b": false}, {"t": "Erster Kurstag: Montag, 13. September", "b": false}, {"t": "Bücher bitte vor dem Kurs im Büro abholen.", "b": false}, {"t": "Informationen telefonisch: 02742/328 oder im Internet: www.vhs-noe.at", "b": false}]}, {"paragraphs": [{"t": "Internationaler Abend", "b": true}, {"t": "Orientalische Musik hören, zu afrikanischen Rhythmen tanzen, Essen aus Österreich genießen.", "b": false}, {"t": "Bei uns treffen sich Kulturen aus aller Welt.", "b": false}, {"t": "Samstag, 27. Juli, ab 20:00 Uhr im Vereinstreff Leopoldsdorf", "b": false}, {"t": "Eintritt: 2 Euro", "b": false}]}, {"paragraphs": [{"t": "Service-Hotline", "b": true}, {"t": "Ist Ihr Kühlschrank kaputt? Dann rufen Sie uns bitte an.", "b": false}, {"t": "Wir helfen Ihnen gerne und sind von 6 bis 22 Uhr für Sie da.", "b": false}, {"t": "Tel.: 0800 100 107", "b": false}, {"t": "Garantie auf Neugeräte: 2 Jahre", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
    ...
    ('hv1', 'Hören', 'Hören, Teil 1', 4, 'Sie hören fünf verschiedene Texte zu den Fotos. Welcher Text passt zu welchem Foto? Ein Bild ist zu viel.', 'matching', '{"bank": [{"key": "A", "text": "Foto A"}, {"key": "B", "text": "Foto B"}, {"key": "C", "text": "Foto C"}, {"key": "D", "text": "Foto D"}, {"key": "E", "text": "Foto E"}, {"key": "F", "text": "Foto F"}], "bankTitle": "Fotos", "bankImage": "img/oesd-a1-m05-hv1.jpg", "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 2, "audio": "oesd-a1-m05-hv1.mp3", "audioPlays": 2}'::jsonb, 3),
    ('hv2', 'Hören', 'Hören, Teil 2 (Telefonnotiz)', 3, 'Sie hören eine Nachricht. Hören Sie gut zu und schreiben Sie die wichtigsten Informationen auf das Notizblatt. Sie hören den Text zwei Mal.', 'writing', '{"passages": [{"paragraphs": [{"t": "Notizen: Wohnung anschauen", "b": true}, {"t": "Was: Wohnung anschauen", "b": false}, {"t": "Wann: am ............................, den ............................ März, um ............................ Uhr", "b": false}, {"t": "Wo: ............................straße 68", "b": false}, {"t": "Telefonnummer: 0650/ ............................", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 10, "audio": "oesd-a1-m05-hv2.mp3", "audioPlays": 2}'::jsonb, 4),
    ('hv3', 'Hören', 'Hören, Teil 3', 3, 'Sie hören jetzt 5 Personen, die befragt werden: „Wo möchten Sie am liebsten arbeiten?“ Kreuzen Sie die richtige Antwort an. Pro Person gibt es nur eine Antwort.', 'mc', '{"maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 2, "audio": "oesd-a1-m05-hv3.mp3", "audioPlays": 2}'::jsonb, 5),
...
from (values
    ...
    ('lv2', '7', 'Kann man in der Schule anrufen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Gibt es bei der Party Musik aus Afrika?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Muss man für die Party etwas bezahlen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "Babysitter gesucht!", "b": true}, {"t": "Sie ...", "b": false}, {"t": "✿ lieben Kinder?", "b": false}, {"t": "✿ können Auto fahren?", "b": false}, {"t": "✿ sprechen gut Deutsch und Englisch?", "b": false}, {"t": "✿ haben von Samstag bis Mittwoch Zeit?", "b": false}, {"t": "Dann haben wir den richtigen Job für Sie!", "b": false}, {"t": "Fam. Moosburger", "b": false}, {"t": "gabriela.moosburger@yahoo.de", "b": false}]}, {"paragraphs": [{"t": "Haus mit Garten zu verkaufen!", "b": true}, {"t": "Besichtigen möglich ab Donnerstag, 17.05., täglich zwischen 09:00 und 13:30 Uhr!", "b": false}, {"t": "Für weitere Informationen melden Sie sich bitte direkt bei Julia Berger.", "b": false}, {"t": "julia.berger@gmx.at", "b": false}, {"t": "0664 / 8154026 (ab 12:30 Uhr)", "b": false}]}, {"paragraphs": [{"t": "TIERPARK Beck in Hamburg", "b": true}, {"t": "Nach der Winterpause sind wir endlich wieder für Sie da!", "b": false}, {"t": "Dienstag–Sonntag: 09–20 Uhr", "b": false}, {"t": "Unser Frühlings-Angebot im März:", "b": false}, {"t": "Von 02.03.–15.03. gibt es -25 % auf alle Eintrittskarten!", "b": false}, {"t": "www.tierpark-beck.de", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
...
from (values
    ...
    ('lv2', '7', 'Muss man am Wochenende arbeiten?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Kann man das Haus Anfang Mai ansehen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Kann man Frau Berger am Vormittag anrufen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "Gebrauchte Waschmaschine billig zu verkaufen!", "b": true}, {"t": "Ich habe sie seit 3 Jahren. Sie wäscht noch sehr gut.", "b": false}, {"t": "Rufen Sie mich gerne an – bitte erst ab 17 Uhr.", "b": false}, {"t": "Emma 0650/4585612", "b": false}]}, {"paragraphs": [{"t": "Liebe Kunden, aktuell in unserem Supermarkt:", "b": true}, {"t": "• Getränke 20 % billiger", "b": false}, {"t": "• Original Schweizer Käse um 10 Euro/Kilo", "b": false}, {"t": "• NEU: Blumen und Kräuter für Garten und Balkon", "b": false}, {"t": "Jetzt auch online einkaufen:", "b": false}, {"t": "www.kaufmarkt.de", "b": false}]}, {"paragraphs": [{"t": "Besuchen Sie Bern", "b": true}, {"t": "Drei Nächte für 2 Personen im Gästehaus Andermatt um nur 300 Franken.", "b": false}, {"t": "• zentrale Lage", "b": false}, {"t": "• Tram-Haltestelle vor der Tür (fährt auch zum Bahnhof)", "b": false}, {"t": "• ohne Frühstück", "b": false}, {"t": "www.gaestehaus-andermatt.ch", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
...
from (values
    ...
    ('lv2', '7', 'Hat Emma am Vormittag Zeit zum Telefonieren?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Kostet Apfelsaft jetzt weniger?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Gibt es im Supermarkt auch Pflanzen?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
...
from (values
    ...
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Sie lesen drei Anzeigen. Dazu gibt es je 2 Fragen. Antworten Sie mit JA oder NEIN.', 'mc', '{"passages": [{"paragraphs": [{"t": "NEUE DEUTSCHKURSE", "b": true}, {"t": "★ 1. bis 31. August", "b": false}, {"t": "★ Anmeldung: Mo.–Fr. 09:00–11:00 Uhr, im Zimmer 19 bei Frau Dorn", "b": false}, {"t": "★ Mitbringen: Reisepass, Führerschein o. Ä.", "b": false}, {"t": "★ Welcher Kurs ist der richtige? Online-Test: www.deutschmachtspass.at/kurse", "b": false}]}, {"paragraphs": [{"t": "Wald-Fest", "b": true}, {"t": "Freitag: Beginn um 20:00 Uhr mit DJ Ron", "b": false}, {"t": "Samstag: Live-Musik ab 11:00 Uhr, -50 % auf Ihr erstes Getränk (bis 15:00 Uhr)", "b": false}, {"t": "Samstag und Sonntag: Spaß und Spiele für kleine Gäste ab 4 Jahren (bis 15:00 Uhr)", "b": false}]}, {"paragraphs": [{"t": "Jumping Fitness-Kurs – Trainieren Sie 300 Muskeln auf einmal!", "b": true}, {"t": "Dienstag bis Donnerstag und Samstag 9–10:30 Uhr", "b": false}, {"t": "Hubertstraße 87, 28757 Bremen", "b": false}, {"t": "Direkt bar im Kurs bezahlen. Die erste Stunde kostet nichts!", "b": false}, {"t": "www.jumpingfitness.de", "b": false}]}], "maxPoints": 10, "availablePoints": 10, "missing": 0, "pointsPerItem": 1.67}'::jsonb, 1),
...
from (values
    ...
    ('lv2', '7', 'Braucht man bei Frau Dorn einen Ausweis?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 1),
    ('lv2', '8', 'Sind Getränke am Samstagabend billiger?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 2),
    ('lv2', '9', 'Gibt es am Wochenende ein Kinderprogramm?', '[{"key": "A", "text": "JA"}, {"key": "B", "text": "NEIN"}]'::jsonb, 1.67, null::jsonb, 3),
