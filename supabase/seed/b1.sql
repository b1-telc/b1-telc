...
from (values
    ...
    ('hv1', '41', 'Die Sprecherin wünscht sich einen Arbeitsplatz für ihren Vater.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Der Sprecher ist kein besonders guter Schüler.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Die Sprecherin möchte nicht immer gestört werden.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Der Sprecher versteht sich nicht gut mit seiner Mutter.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Die Sprecherin ist am liebsten mit ihren Eltern zusammen.', null::jsonb, 5, null::jsonb, 4),
    ...
    ('hv3', '56', 'Sie sollen um 19:30 Uhr bei Georg und Claudia sein.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Im südlichen Österreich ist es tagsüber sonnig, später windig und regnerisch', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Der Speisewagen befindet sich im hinteren Teil des Zuges.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Die Schweizer geben für Urlaub mehr Geld aus als für ihre Gesundheit.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Der Sänger beginnt seine Konzertreise mit einer Vorstellung in Wien', null::jsonb, 5, null::jsonb, 4),
...
select s.id, v.item_id, v.text, v.options, v.points, v.meta, v.sort
from (values
    ('lv1', '1', 'Frauen lachen auf viele Arten Sie kichern glucksen und manchmal singen sie fast Bei Männern dagegen kommt das viel seltener vor. Aber gemeinsam ist Männern und Frauen, dass sie in Vokalen lachen die im Mundzentrum gebildet werden. Und das ist entscheidend: Nur wenn die Vokale im Mundzentrum gebildet werden, ist das Lachen für uns fröhlich und positiv. Damit ist bewiesen, dass das Lachen vom Weihnachtsmann, dass wie eine tiefes Ho, ho, ho klingt. Kaum als fröhlich empfunden wird. Denn dieser Laut wird im hinteren Teil des Mundraums gebildet. (aus einer deutschen Zeitung)', null::jsonb, 5, null::jsonb, 0),
    ('lv1', '2', 'Viel Arbeit, viel Stress. Wer viel arbeitet muss nicht unbedingt gestresst sein. Frauen in medizinischen Berufen zum Beispiel klagen trotz teilweise hoher Belastung deutlich weniger über stressbedingte Krankheiten als Raumpflegerinnen, Kindergärtnerinnen oder Berufsschullehrerinnen. Dies zeigt eine Untersuchung des Hamburger IPO Instituts, das für eine Studie 1000 Frauen und Männer befragt hat. Vor Stress schützen laut Studie ein angenehmes Betriebsklima, ein gutes Verhältnis zur Chefin oder zum Chef und die Möglichkeit, die eigene Arbeit selbstständig zu planen. (aus einer deutschen Zeitung)', null::jsonb, 5, null::jsonb, 1),
    ('lv1', '3', 'Ein neues Buch zeigt, wie Männer Fähigkeiten aus dem Arbeitsleben auf die Erziehung übertragen können und so zu erfolgreichen Vätern werden. Da wird die gemeinsame Kindererziehung zur Partnerarbeit (oder sogar zum Joint Venture) geschicktes Verhandeln heißt, das Kind zu überzeugen, dass sie Zähne geputzt werden müssen, und der Familienurlaub hat alle Qualitäten einer Tagung oder eines Seminars: Man erhält die Gelegenheit, die Kinder intensiv zu studieren. (aus einer deutschen Zeitung)', null::jsonb, 5, null::jsonb, 2),
    ('lv1', '4', 'Eine Studie der Universität Essex hat ergeben dass wir mit siebzig Jahren am glücklichsten sind. Zwar haben die meisten Menschen in diesem Alter gesundheitliche Probleme, aber dafür genießen sie viel Freizeit und haben keinen Stress mehr. Deshalb macht ihnen das Leben so viel Spaß wie nie zuvor. Die Studie besagt auch, dass wir einen ersten Höhepunkt der Lebensfreude mit fünfzehn Jahren erreichen. Danach geht es bergab zwischen dreißig und fünfzig Jahren tragen wir am meisten Verantwortung das Leben ist geprägt von Sachzwängen. (aus einer deutschen Zeitung)', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', 'Warum bleiben manche Managerinnen erfolgreich, obwohl sie Nachrichten mitteilen, die ihr Publikum lieber nicht hören möchte? Ganz einfach: Sie verkaufen die schlechte Nachricht mit Humor. Ein Londoner Soziologe hat während einer Studie beobachtet, dass gerade bei Reden unangenehmen Inhalts oft heiter gelacht wird. Das Lachen wird bewusst provoziert, etwa durch bestimmte Wörter oder durch ein eigenes breites Lächeln. Die fröhliche Stimmung soll dafür sorgen, dass die Zuhörenden das Gefühl haben würden mehr wissen als alle anderen. (aus einer deutschen Zeitung)', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Der Schweizer Schlafforscher Alexander Borbety', '[{"key": "A", "text": "behauptet, dass der gesunde Schlaf gleichmäßig ist."}, {"key": "B", "text": "beschäftigt sich seit 50 Jahren mit dem Thema Schlaf."}, {"key": "C", "text": "meint, dass es beim Schlaf verschiedene Stufen gibt."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Während der Leichtschlafphase', '[{"key": "A", "text": "erholt man sich nicht gut."}, {"key": "B", "text": "träumt man besonders viel."}, {"key": "C", "text": "wacht man öfter auf."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Die Wissenschaft ist heute der Meinung, dass', '[{"key": "A", "text": "alle Probleme des Schlafes gelöst sind."}, {"key": "B", "text": "der Schlaf der Körperlichen Erholung dient."}, {"key": "C", "text": "man durch Schlafen viel Zeit verliert."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Vor allem die Menschen in westlichen Ländern', '[{"key": "A", "text": "klagen darüber, dass sie schlecht schlafen können."}, {"key": "B", "text": "können ohne Sorgen und Probleme schlafen."}, {"key": "C", "text": "werden beim Schlafen gelegentlich gestört."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'Zum Arzt sollen die Menschen gehen, die', '[{"key": "A", "text": "längere Zeit sehr schlecht schlafen."}, {"key": "B", "text": "manchmal nachts aufwachen."}, {"key": "C", "text": "zu viel und zu lange schlafen."}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('hv1', '41', 'Herr Pawliczek erledigt alle seine Einkäufe im Internet.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Frau Zimmermann legt beim Einkaufen großen Wert auf persönlichen Kontakt.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Frau Schmidt findet zu Hause nicht genug Ruhe, um im Internet einzukaufen.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Frau Ruttnigg ist vom Einkaufen im Internet nicht überzeugt.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Herr Krause kauft seine Medikamente am liebsten in der nächsten Stadt.', null::jsonb, 5, null::jsonb, 4),
    ...
    ('hv3', '56', 'Sie müssen in Ingolstadt die Regionalbahn nach Regensburg nehmen.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Clara kann wegen einer Prüfung die Theaterkarten nicht abholen.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Im Schwarzwald können die Straßen morgen glatt werden', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Der Liederabend findet zu einem späteren Termin statt', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Im Untergeschoss gibt es Winterkleidung zum halben Preis.', null::jsonb, 5, null::jsonb, 4),
...
values ('b1', 'modell-03', 'SOPHIE', '61 Aufgaben · 150 Minuten',
        '[{"id": "block-lv-sb", "title": "Leseverstehen und Sprachbausteine", "minutes": 90, "hint": "Aufgaben 1–40", "parts": ["lv1", "lv2", "lv3", "sb1", "sb2"], "maxPoints": 105, "availablePoints": 105, "missing": 0}, {"id": "block-hv", "title": "Hörverstehen", "minutes": 30, "hint": "Aufgaben 41–60", "parts": ["hv1", "hv2", "hv3"], "maxPoints": 75, "availablePoints": 75, "missing": 0}, {"id": "block-sa", "title": "Schriftlicher Ausdruck", "minutes": 30, "hint": "", "parts": ["sa"], "maxPoints": 45, "availablePoints": 45, "missing": 0}]'::jsonb, 61, true, 3)
on conflict (level_id, slug) do update set title = excluded.title, subtitle = excluded.subtitle, blocks = excluded.blocks, aufgaben = excluded.aufgaben, sort = excluded.sort;
...
select s.id, v.item_id, v.text, v.options, v.points, v.meta, v.sort
from (values
    ('lv1', '1', 'Eine aktuelle Umfrage der Arbeiterkammer unter berufstätigen Eltern zeigt den dringenden Wunsch nach flexiblen Arbeitszeiten (60% der Eltern) und nach Kindergärten im oder in der Nähe des Betriebes (58%). Frauen verlangen aber deutlich mehr Teilzeitarbeitsplätze (50%) als Männer (36%). 52% aller Eltern wünschen eine Ersatzperson, die den Vater oder die Mutter bei Krankheit des Kindes im Betrieb vertritt. Die Arbeiterkammer fordert, dass sich Bedarf der Eltern orientieren.', null::jsonb, 5, null::jsonb, 0),
    ('lv1', '2', 'MÜNCHEN: Schüler an bayerischen Gymnasien, die sich für Umwelt oder Technik interessieren, können sich auch dieses Jahr wieder um den Carl Friedrich von Martius Umwelt und Technikpreis bewerben. Bei diesem Wettbewerb werden Facharbeiten aus dem letzten Schuljahr bewertet. Nähere Informationen erhältlich beim GSF- Forschungszentrum unter der Telefonnummer 089/311 87 27 12.', null::jsonb, 5, null::jsonb, 1),
    ('lv1', '3', 'WIEN. Eine einmalige Abteilung für drei- bis sechsjährige Kinder wurde im Technischen Museum (15, Mariahitferstraße 112 ) eröffnet. In einem speziell für Kinder eingerichteten Bereich können die jüngsten Besucher Technik angreifen. Dort gibt es unter anderem Plasmascheiben, die Blitze erzeugen, ein Laufrad und ein Hüpfklavier, mit dem die Kinder Töne erspringen können. Viel Spaß macht den Kleinen auch, in einem Elektroauto herumzukurven und sich in verschiedenen Zerrspiegeln zu betrachten.', null::jsonb, 5, null::jsonb, 2),
    ('lv1', '4', 'HAMBURG. Männer haben mehr Karrierechancen, Frauen dafür mehr Freude am Beruf: Das ergab eine große Umfrage in Hamburg. Obwohl nur 8% der weiblichen Arbeitnehmer an ihre Aufstiegschancen glauben, geben 61% an, dass ihre Arbeit ihnen Spaß mache. Bei den Männer ist dieses Verhältnis 23 zu 57 Prozent.', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', 'Für Zufriedenheit am Arbeitsplatz kann Geld allein nicht entscheidend sein. Dies gilt in besonderen Maß für hochqualifizierte europäische Arbeitskräfte, wie eine vergleichende internationale Management-Studie zeigt. Sowohl in Europa wie auch unter japanischen und amerikanischen Managern wird der Möglichkeit, neben der Arbeit auch Zeit für das Privatleben zu haben, ein zentraler Stellenwert beigemessen. Viel stärker als in Japan spielt es unter europäischen Angestellten eine Rolle, dass die Arbeit Spaß macht. Die Analysen zeigen auch, dass neben dem Gehalt der Ruf des Unternehmens für die Arbeitsplatzwahl von europäischen Arbeitnehmern besonders wichtig ist.', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Die Maus', '[{"key": "A", "text": "führt Kinder durch das Museum."}, {"key": "B", "text": "wird in einer Werbefirma gezeichnet."}, {"key": "C", "text": "wurde von Friedrich Streich erfunden."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Das Thema der Ausstellung', '[{"key": "A", "text": "ist die Geschichte der Sendung mit der Maus."}, {"key": "B", "text": "ist 30 Jahre Junges Museum."}, {"key": "C", "text": "sind Kinder aus aller Welt."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Die Sendung mit der Maus', '[{"key": "A", "text": "erhält Post aus der ganzen Welt."}, {"key": "B", "text": "hat es schwer, noch neue Themen zu finden."}, {"key": "C", "text": "nimmt nur Vorschläge von Kindern an."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Die Ausstellung', '[{"key": "A", "text": "erlaubt den Kindern, mit den Ausstellungsstücken zu spielen."}, {"key": "B", "text": "erlaubt den Kindern nicht, die Ausstellungsstücke anzufassen."}, {"key": "C", "text": "ist nur für Kinder geöffnet."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'Die Maus', '[{"key": "A", "text": "erhält von den Kindern Geschenke aus verschiedenen Materialien."}, {"key": "B", "text": "gibt es nur auf Postkarten und Plakaten zu kaufen."}, {"key": "C", "text": "ist aus Wolle und Papier."}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('hv1', '41', 'Der Sprecher hat zu Hause keinen Computer.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Der Sprecher benutzt den Computer nur am Arbeitsplatz.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Die Sprecherin lehnt Computer ab.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Die Sprecherin hat kein großes Vertrauen zu Computern.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Die Sprecherin braucht den Computer im täglichen Leben.', null::jsonb, 5, null::jsonb, 4),
    ...
    ('hv3', '56', 'Der Fahrer des Wagens mit dem Kennzeichen HB-D 256 soll ins Erdgeschoss kommen.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Die Firma liefert das bestellte Sofa am Dienstag ab drei Uhr nachmittags.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Der Gasthof Lindner ist neben einer Tankstelle.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Der Film Komiker läuft täglich um 20 Uhr.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Das Wetter ist am Abend noch gut.', null::jsonb, 5, null::jsonb, 4),
...
from (values
    ...
    ('lv1', '5', '– Des Gallup Instituts hat sich mit Kaffeehausverhaltens der Wiener Ein Vorurteil hat sich dabei bestätigt Kaffeehaus und der Wiener Seine Melange Ergebnisse der Studie 27 der an, zumindest einmal im Monat der Nähe ihrer Wohnung zu gehen. Durchschnittlich 54 Minuten Befragten in ihrem Stamm Café Kundschaft umso länger wird gegessen. Der Grund ein Kaffeehaus wichtiger ist das Plaudern und Freunden. 77 der Befragten Grund für den Besuch im Kaffeehaus.', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Volkmar Bergmann', '[{"key": "A", "text": "wollte bei einer anderen Firma arbeiten."}, {"key": "B", "text": "wollte mehr Zeit für sein Privatleben haben."}, {"key": "C", "text": "wollte nur noch nachts und an Wochenenden arbeiten."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Es gibt viele Menschen,', '[{"key": "A", "text": "die gerne einen anderen Schreibtisch hätten."}, {"key": "B", "text": "die heute bereits arbeitskrank sind."}, {"key": "C", "text": "die pro Woche nur noch 24 Stunden arbeiten."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Durch die moderne Technik', '[{"key": "A", "text": "haben die Menschen mehr Zeit für das Privatleben."}, {"key": "B", "text": "kann die Arbeit fast überall erledigt werden."}, {"key": "C", "text": "wird es in Zukunft immer weniger Arbeit geben."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Laut Professor Robinson', '[{"key": "A", "text": "wollen viele Menschen weniger arbeiten."}, {"key": "B", "text": "kann viel Arbeit den Menschen gut tun."}, {"key": "C", "text": "leben viele Menschen nur noch für ihren Beruf."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'In Seminaren sollen die Teilnehmer lernen,', '[{"key": "A", "text": "kranken Mitarbeitern zu helfen."}, {"key": "B", "text": "wie man die Arbeit im Büro besser organisieren kann."}, {"key": "C", "text": "ein gesundes Verhältnis zur Arbeit zu finden."}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('hv1', '41', 'Die Sprecherin wäre lieber ein Einzelkind.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Der Sprecher hat heute ein gutes Verhältnis zu seinem Bruder.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Die Sprecherin würde heute gern noch eine Schwester haben.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Die Sprecherin hat schon früh lernen müssen, dass man im Zusammenleben viel Rücksicht nehmen muss.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Die Sprecherin versteht sich sehr gut mit ihrem Bruder.', null::jsonb, 5, null::jsonb, 4),
...
from (values
    ...
    ('hv1', '41', 'Der Sprecher interessiert sich für Sport als für Kultur.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Die Sprecherin geht so oft sie kann ins Theater.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Der Sprecher hört besonders gern moderne Musik.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Die Sprecherin geht oft in Kunstausstellungen.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Die Sprecherin hätte gerne mehr Zeit für die Kultur.', null::jsonb, 5, null::jsonb, 4),
    ('hv2', '46', 'Die Lehrerin fährt mit ihrer Klasse und an die Nordsee.', null::jsonb, 2.5, null::jsonb, 0),
    ('hv2', '47', 'Herr Kühne hat den Brief der Lehrerin nicht erhalten.', null::jsonb, 2.5, null::jsonb, 1),
    ('hv2', '48', 'Die Klassenfahrt beginnt an einem Samstag.', null::jsonb, 2.5, null::jsonb, 2),
    ('hv2', '49', 'Herrn Kühnes Sohn Martin wird bei Busfahrten oft schlecht.', null::jsonb, 2.5, null::jsonb, 3),
    ...
    ('hv2', '54', 'Katerina kann entweder mitfahren, oder in eine andere Klasse gehen.', null::jsonb, 2.5, null::jsonb, 8),
    ('hv2', '55', 'Auf der Klassenfahrt darf nur mit Erlaubnis der Eltern geraucht werden.', null::jsonb, 2.5, null::jsonb, 9),
    ('hv3', '56', 'Sie können mit dem Bus in die Innenstadt fahren.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Sie können noch eine Stunde durch alle Geschäfte laufen.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Dr. Krausch ist ab dem 18. Oktober wieder in der Praxis.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Alle Kunden müssen an der Kasse nebenan bezahlen.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Die Polizei informiert, dass alle Parkhäuser bei der Ausstellung besetzt sind.', null::jsonb, 5, null::jsonb, 4),
...
select s.id, v.item_id, v.text, v.options, v.points, v.meta, v.sort
from (values
    ('lv1', '1', 'In Deutschland lernen nur ganz wenige Schüler Griechisch. Es sind insgesamt nur 0.14 aller Schüler. Vor 30 Jahren waren es noch 0,48 So berichtet die griechische Botschaft in Berlin in ihrem Europabericht. Griechisch wird meistens von Zwölftklässlern als dritte Fremdsprache neben Französisch und Englisch gewählt. Die wenigen Schüler, die Griechisch wählen, haben Verwandte in Griechenland.', null::jsonb, 5, null::jsonb, 0),
    ('lv1', '2', 'Dem Meer verdankt die Hansestadt Bremen ihre Bedeutung. Bremer Kaufleute und Seefahrer nutzten die günstige geografische Lage, um in aller Welt heimisch zu werden. Seit Generationenhaben sie Handel getrieben, so dass Geld in die Stadt. Dies steht man der Stadt heute noch an: das Alte Rathaus, das Kaufmannhaus, die historische Innenstadt. Außerdem war Bremen auch immer eine Heimat für natürlich das Märchen der Bremer Stadtmusikanten.', null::jsonb, 5, null::jsonb, 1),
    ('lv1', '3', 'Freiburg, die Hauptstadt des Schwarzwaldes, liegt in einer der sonnigsten Gegenden Deutschlands. Wo es so viel Sonne gibt, da ist auch viel Lebensfreude, und nicht zuletzt gehören auch badische Küche und badischer Wein zum Besten was in Deutschland geboten wird. Zum einmaligen Flair gemütlichen Universitätsstadt trägt auch ihre Lage bei. Frankreich und die Schweiz sind nicht weit entfernt. Die Stadt selbst lockt mit vielen alten Straßen mit zahlreichen Museen und Baudenkmälern. Über alles hinaus ragt die große Kirche, die nach 300 jähriger Bauzeit 1513 vollendet wurde.', null::jsonb, 5, null::jsonb, 2),
    ('lv1', '4', 'In einer wissenschaftlichen Untersuchung hat man erforscht, warum bestimme Menschen mehr Geld verdienen als andere. Britische Wissenschaftler behaupten, größeren Menschen zahlt der Chef mehr. Im Laufe des vergangenen Jahres haben zwei weitere Untersuchungen festgestellt: Wer wenig lacht oder häufig mit Kollegen trinken geht, verdient mehr nur: Nicht lachen und mit Kollegen trinken, gehen das kann man lernen. Aber wachsen?', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', 'Das Statistische Bundesamt berichtet, dass in deutschen Schulen allgemein wieder mehr Latein gelernt wird. Allein in Thüringen hat sich die Anzahl in den letzten beiden Jahren verdoppelt Während der Tiefpunkt bei Latein im vorletzten Jahr erreicht war, wählen zurzeit wieder mehr Schüler Latein als erste Fremdsprache. Als vorteilhaft hat sich offenbar vor allem das wittenbergische Modell erwiesen, das Latein in der fünften Klasse mit einer modernen Fremdsprache (Französisch, Englisch usw.) kombiniert Allerdinges sind hier meist nur drei Stunden für beide Sprachen pro Woche vorgesehen. Das sei bei Weitem zu wenig, Kritisieren Lateinlehrer Weitem zu wenig kritisieren Lateinlehrer.', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Gerhard Spur', '[{"key": "A", "text": "arbeitet heute nur noch mit der rechten Hand."}, {"key": "B", "text": "arbeitet früher mit Linkshändern zusammen."}, {"key": "C", "text": "stellt seine Kunstwerke mit der linken Hand her"}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Heute ist wissenschaftlich bewiesen, dass', '[{"key": "A", "text": "es eine klare Ursache für Linkshändigkeit gibt."}, {"key": "B", "text": "Linkshänder besser im Lesen und Schreiben sind."}, {"key": "C", "text": "Linkshänder das Schreiben mit der rechten Hand schadet."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Erich Pospischill meint, dass', '[{"key": "A", "text": "es für Linkshänder sehr oft keine geeigneten Arbeitsplätze gibt."}, {"key": "B", "text": "Linkshänder vor allem im Computerbereich eingesetzt werden."}, {"key": "C", "text": "Linkshänder wesentlich öfter krank sind."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Frau Slata Tanasic', '[{"key": "A", "text": "arbeitet seit 21 Jahren in der gleichen Firma."}, {"key": "B", "text": "erledigt alle Arbeiten mit der linken Hand."}, {"key": "C", "text": "ist seit 21 Jahren an der gleichen Maschine beschäftigt."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'Laut der Linkshänder-Expertin Johanna Sattier', '[{"key": "A", "text": "haben Linkshänder meistens auch linkshändige Eltern."}, {"key": "B", "text": "kann man Linkshändigkeit bei kleinen Kindern nicht gleich entdecken."}, {"key": "C", "text": "sind linkshändige Kinder besonders gut im Ballspielen."}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('hv1', '41', 'Die Sprecherin könnte sich vorstellen, mit dem Bus zur Arbeit zu fahren.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Die Sprecherin findet es gut, dass sie zur Arbeit ein Stück zu Fuß gehen kann.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Der Sprecher fährt nie mit dem Auto zur Arbeit.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Der Sprecher benutzt für den Weg zur Arbeit zurzeit verschiedene Verkehrsmittel.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Für die Sprecherin ist der Firmenbus die einzige Möglichkeit zur Arbeit zu kommen.', null::jsonb, 5, null::jsonb, 4),
...
values ('b1', 'modell-08', 'IRIS1', '61 Aufgaben · 150 Minuten',
        '[{"id": "block-lv-sb", "title": "Leseverstehen und Sprachbausteine", "minutes": 90, "hint": "Aufgaben 1–40", "parts": ["lv1", "lv2", "lv3", "sb1", "sb2"], "maxPoints": 105, "availablePoints": 105, "missing": 0}, {"id": "block-hv", "title": "Hörverstehen", "minutes": 30, "hint": "Aufgaben 41–60", "parts": ["hv1", "hv2", "hv3"], "maxPoints": 75, "availablePoints": 75, "missing": 0}, {"id": "block-sa", "title": "Schriftlicher Ausdruck", "minutes": 30, "hint": "", "parts": ["sa"], "maxPoints": 45, "availablePoints": 45, "missing": 0}]'::jsonb, 61, true, 8)
on conflict (level_id, slug) do update set title = excluded.title, subtitle = excluded.subtitle, blocks = excluded.blocks, aufgaben = excluded.aufgaben, sort = excluded.sort;
...
from (values
    ...
    ('lv1', '4', 'Eine Studie der Universität Essex hat ergeben dass wir mit siebzig Jahren am glücklichsten sind. Zwar haben die meisten Menschen in diesem Alter gesundheitliche Probleme, aber dafür genießen sie viel Freizeit und haben keinen Stress mehr. Deshalb macht ihnen das Leben so viel Spaß wie nie zuvor. Die Studie besagt auch, dass wir einen ersten Höhepunkt der Lebensfreude mit fünfzehn Jahren erreichen. Danach geht es bergab zwischen dreißig und fünfzig Jahren tragen wir am meisten Verantwortung das Leben ist geprägt von Sachzwängen. (aus einer deutschen Zeitung)', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', 'Warum bleiben manche Managerinnen erfolgreich, obwohl sie Nachrichten mitteilen, die ihr Publikum lieber nicht hören möchte? Ganz einfach: Sie verkaufen die schlechte Nachricht mit Humor. Ein Londoner Soziologe hat während einer Studie beobachtet, dass gerade bei Reden unangenehmen Inhalts oft heiter gelacht wird. Das Lachen wird bewusst provoziert, etwa durch bestimmte Wörter oder durch ein eigenes breites Lächeln. Die fröhliche Stimmung soll dafür sorgen, dass die Zuhörenden das Gefühl haben würden mehr wissen als alle anderen. (aus einer deutschen Zeitung)', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Um Berufe kennenzulernen,', '[{"key": "A", "text": "arbeiten Berner Schüler in den Ferien bei großen Firmen."}, {"key": "B", "text": "nehmen Berner Schüler an Informationsveranstaltungen von großen Firmen teil."}, {"key": "C", "text": "sollen Berner Schüler zweimal jährlich ein Praktikum machen."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Frau Leiser', '[{"key": "A", "text": "erzählt aus ihrem Berufsalltag in der Bank."}, {"key": "B", "text": "stellt die wichtigsten Aufgaben der Bank vor."}, {"key": "C", "text": "zeigt den Jugendlichen die ganze Firma."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'An dem Informationsnachmittag', '[{"key": "A", "text": "bekamen die Jugendlichen eine Liste mit Bewerbungstipps."}, {"key": "B", "text": "war die Gruppe interessiert und hat gut zugehört."}, {"key": "C", "text": "wurden viele Fragen gestellt."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Tugba Kaptan', '[{"key": "A", "text": "fand es gut, dass sie am Schalter arbeiten durfte."}, {"key": "B", "text": "fand es schade, dass an diesem Nachmittag die Schule ausgefallen ist."}, {"key": "C", "text": "hat viele Informationen bekommen."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'Alan Blank', '[{"key": "A", "text": "möchte später gern bei einer Bank arbeiten."}, {"key": "B", "text": "möchte viele Dinge besser nicht selbst entscheiden."}, {"key": "C", "text": "weiß noch nicht, was er machen will."}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('hv1', '41', 'Für die Sprechen ist es unwichtig, ob ihre Kinder in der Schule gut sind.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Der Sprecher findet es wichtig, dass Eltern immer für ihre Kinder da sind.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Die Sprecherin glaubt, dass sie mehr mit ihrer Tochter sprechen müsste.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Es ist dem Sprecher wichtig, dass seine Kinder gesund leben.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Der Sprecher möchte, dass sein Kind die eigenen Ideen realisieren kann.', null::jsonb, 5, null::jsonb, 4),
    ...
    ('hv3', '56', 'Die Linie 2 fährt zum Hauptbahnhof.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Das Hallenbad schließt heute um 21:00 Uhr.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Sie können mit der S1 nach Hütteldorf fahren.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Badezimmerspiegel finden Sie im Untergeschoss.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Sie können gleich in Richtung Eilenburg umsteigen.', null::jsonb, 5, null::jsonb, 4),
...
values ('b1', 'modell-09', 'CAROLINA', '61 Aufgaben · 150 Minuten',
        '[{"id": "block-lv-sb", "title": "Leseverstehen und Sprachbausteine", "minutes": 90, "hint": "Aufgaben 1–40", "parts": ["lv1", "lv2", "lv3", "sb1", "sb2"], "maxPoints": 105, "availablePoints": 105, "missing": 0}, {"id": "block-hv", "title": "Hörverstehen", "minutes": 30, "hint": "Aufgaben 41–60", "parts": ["hv1", "hv2", "hv3"], "maxPoints": 75, "availablePoints": 75, "missing": 0}, {"id": "block-sa", "title": "Schriftlicher Ausdruck", "minutes": 30, "hint": "", "parts": ["sa"], "maxPoints": 45, "availablePoints": 45, "missing": 0}]'::jsonb, 61, true, 9)
on conflict (level_id, slug) do update set title = excluded.title, subtitle = excluded.subtitle, blocks = excluded.blocks, aufgaben = excluded.aufgaben, sort = excluded.sort;
...
values ('b1', 'modell-10', 'VERA', '61 Aufgaben · 150 Minuten',
        '[{"id": "block-lv-sb", "title": "Leseverstehen und Sprachbausteine", "minutes": 90, "hint": "Aufgaben 1–40", "parts": ["lv1", "lv2", "lv3", "sb1", "sb2"], "maxPoints": 105, "availablePoints": 105, "missing": 0}, {"id": "block-hv", "title": "Hörverstehen", "minutes": 30, "hint": "Aufgaben 41–60", "parts": ["hv1", "hv2", "hv3"], "maxPoints": 75, "availablePoints": 75, "missing": 0}, {"id": "block-sa", "title": "Schriftlicher Ausdruck", "minutes": 30, "hint": "", "parts": ["sa"], "maxPoints": 45, "availablePoints": 45, "missing": 0}]'::jsonb, 61, true, 10)
on conflict (level_id, slug) do update set title = excluded.title, subtitle = excluded.subtitle, blocks = excluded.blocks, aufgaben = excluded.aufgaben, sort = excluded.sort;

insert into sections (test_id, section_id, "group", title, minutes, instruction, format, config, sort)
select t.id, v.section_id, v.grp, v.title, v.minutes, v.instruction, v.format, v.config, v.sort
from (values
    ('lv1', 'Leseverstehen', 'Leseverstehen, Teil 1', 15, 'Lesen Sie die Überschriften a–j und die Texte 1–5. Finden Sie für jeden Text die passende Überschrift. Jede Überschrift passt nur einmal.', 'matching', '{"bank": [{"key": "A", "text": "Abendwanderungen ab89Euro"}, {"key": "B", "text": "Ausflugsziele für Literaturinteressierte"}, {"key": "C", "text": "Hinweis für Besucher der Bregenzer Festspiele"}, {"key": "D", "text": "Ihre Zeitung folgt Ihnen in den Urlaub"}, {"key": "E", "text": "Laute Musik stört den Nachbarn"}, {"key": "F", "text": "MusikveranstaltungenamNachmittag"}, {"key": "G", "text": "Neue Zeitung für Ihre Urlaubsplanung"}, {"key": "H", "text": "Rekord: 70.000 Besucher im Bücherdorf"}, {"key": "I", "text": "Schlechtes Wetter: Festspiele abgesagt"}, {"key": "J", "text": "Wandern ohne Gepäck"}], "bankTitle": "Überschriften", "maxPoints": 25, "availablePoints": 25, "missing": 0, "pointsPerItem": 5}'::jsonb, 0),
    ...
    ('lv3', 'Leseverstehen', 'Leseverstehen, Teil 3', 20, 'Lesen Sie die Situationen 11–20 und die Anzeigen im Bild. Finden Sie für jede Situation die passende Anzeige. Wenn Sie keine passende Anzeige finden, wählen Sie X.', 'matching', '{"bank": [{"key": "A", "text": ""}, {"key": "B", "text": ""}, {"key": "C", "text": ""}, {"key": "D", "text": ""}, {"key": "E", "text": ""}, {"key": "F", "text": ""}, {"key": "G", "text": ""}, {"key": "H", "text": ""}, {"key": "I", "text": ""}, {"key": "J", "text": ""}, {"key": "K", "text": ""}, {"key": "L", "text": ""}, {"key": "X", "text": ""}], "bankTitle": "Anzeigen", "bankImage": "img/m10-lv3.jpg", "maxPoints": 25, "availablePoints": 25, "missing": 0, "pointsPerItem": 2.5}'::jsonb, 2),
...
from (values
    ...
    ('hv1', '41', 'Die Sprecherin könnte sich vorstellen, mit dem Bus zur Arbeit zu fahren.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Die Sprecherin geht den ganzen Weg zur Arbeit zu Fuß.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Der Sprecher fährt nie mit dem Auto zur Arbeit.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Der Sprecher benutzt für den Weg zur Arbeit zurzeit verschiedene Verkehrsmittel.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Für die Sprecherin ist der Firmenbus die einzige Möglichkeit zur Arbeit zu kommen.', null::jsonb, 5, null::jsonb, 4),
    ('hv2', '46', 'Viele Touristen besuchen Torgau wegen seiner historischen Sehenswürdigkeiten.', null::jsonb, 2.5, null::jsonb, 0),
    ...
    ('hv2', '54', 'Der Eintritt in den Spielpark ist zurzeit frei.', null::jsonb, 2.5, null::jsonb, 8),
    ('hv2', '55', 'Die Schlossführung bereitet Kindern und Erwachsenen viel Spaß.', null::jsonb, 2.5, null::jsonb, 9),
    ('hv3', '56', 'Sie können zwei Flüge nach Griechenland gewinnen.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Für Ihre Gruppe ist ein Wagen im Zug nach Aschaffenburg reserviert.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Auf der Internetseite kann man auch günstige Angebote für Haushaltsgerät.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Erst morgen Abend bildet sich Nebel..', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Am besten fahren Sie ab Northeim mit dem Bus.', null::jsonb, 5, null::jsonb, 4),
...
from (values
    ...
    ('lv1', '3', 'Berlins jüngster Schriftsteller hat deutlich mehr Texte verfasst als er Jahre zählt. Rund 50 Gedichte und Erzählungen tippte Daniel Story. 12, schon in seiner Computer. Ich schreibe fast, seitdem es mich gibt, sagt der Sechstklässler Bereits mit sieben dichtete er die ersten Verse, jetzt mit zwölf ist er stolz auf seine erste Autorenlesung. Wenn Freunde Fußball spielen, tobt Daniels Phantasie im Kinderzimmer. Warum er lieber schreibt? Daniel: Ich schreibe, weil ich nicht alles erleben kann, was ich denke.', null::jsonb, 5, null::jsonb, 2),
    ('lv1', '4', 'Ob Sie privat oder geschäftlich unterwegs sind, mit dem Stadt Ticket können Sie billig die öffentlichen Verkehrsmittel nutzen. Voraussetzung: Sie sind mit dem Flugzeug oder der Deutschen Bahn(über 100 km) angereist. Gegen einen Aufpreis von nur Euro 2,50 ermöglicht Ihnen das Stadt Ticket auch nach der Ankunft am Zielort freie Fahrt. Mit U- S- oder Straßenbahnen sowie Bussen. Bis zu 48 Stunden. Übrigens: Ihr Stadt Ticket gilt an zwei aufeinanderfolgenden Tagen, die Sie beim Kauf Ihres Fahrscheines selbst bestimmen.', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', 'In Mecklenburg-Vorpommern können junge Leute jetzt für den halben Fahrpreis mit dem Taxi auf Discotour gehen. Tickets dafür sind bei allen Geschäftsstellen der Allgemeinen Ortskrankenkasse (AOK) sowie an Esso Tankstellen zum halben Preis erhältlich. Junge Leute zwischen 16 und 25 Jahren können sie an Wochenenden und Feiertagen in der Zeit von 20 Uhr', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Die Psychologin der Popper-Schule meint, dass', '[{"key": "A", "text": "besonders intelligente Kinder sich stark von anderen Kindern unterscheiden."}, {"key": "B", "text": "besonders intelligente Schüler dieselben Probleme haben wie andere Kinder."}, {"key": "C", "text": "besonders intelligente Schüler weniger Probleme im alltäglichen Leben haben."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Für überdurchschnittlich intelligente Schüler ist typisch, dass Sie', '[{"key": "A", "text": "auch ohne viel Anstrengung gute Noten haben."}, {"key": "B", "text": "nach der Schule immer großen Erfolg im Beruf haben."}, {"key": "C", "text": "sich die Zeit zum Lernen besser als andere einteilen können."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Im Unterricht der Popper-Schule sollen die Schüler', '[{"key": "A", "text": "immer in einer Fremdsprache miteinander sprechen."}, {"key": "B", "text": "in ihren besten Fächern eine spezielle Betreuung bekommen."}, {"key": "C", "text": "in kleinen Gruppen schwächeren Schülern helfen."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Die erste Zeit in der Popper-Schule war für die Schüler schwer, weil', '[{"key": "A", "text": "sich ihre Noten plötzlich verschlechterten."}, {"key": "B", "text": "sie auf einmal viel mehr Zeit mit Lernen verbringen mussten."}, {"key": "C", "text": "sie noch nicht wussten, welche besonderen Talente sie hatten."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'In der Popper-Schule werden nur Schüler aufgenommen,', '[{"key": "A", "text": "die in mindestens einem Fach sehr gut sind."}, {"key": "B", "text": "die mindestens 20 bis 30 Prozent der Aufnahmeprüfung erreichen."}, {"key": "C", "text": "dievonden insgesamt 28Lehrernals intelligent bbeschriebenwerden"}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('hv3', '56', 'In Norddeutschland steigen die Temperaturen morgen auf 5 bis 7 Grad.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Hamburg hat öfter gewonnen als Stuttgart.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Nach zwei Monaten müssen Sie für die Zeitschrift bezahlen.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Auf dem Mittleren Ring in München wird die Geschwindigkeit kontrolliert.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Janas Geburtstagsfest findet nicht im LEO statt.', null::jsonb, 5, null::jsonb, 4),
...
values ('b1', 'modell-12', 'ANDREAS2', '61 Aufgaben · 150 Minuten',
        '[{"id": "block-lv-sb", "title": "Leseverstehen und Sprachbausteine", "minutes": 90, "hint": "Aufgaben 1–40", "parts": ["lv1", "lv2", "lv3", "sb1", "sb2"], "maxPoints": 105, "availablePoints": 105, "missing": 0}, {"id": "block-hv", "title": "Hörverstehen", "minutes": 30, "hint": "Aufgaben 41–60", "parts": ["hv1", "hv2", "hv3"], "maxPoints": 75, "availablePoints": 75, "missing": 0}, {"id": "block-sa", "title": "Schriftlicher Ausdruck", "minutes": 30, "hint": "", "parts": ["sa"], "maxPoints": 45, "availablePoints": 45, "missing": 0}]'::jsonb, 61, true, 12)
on conflict (level_id, slug) do update set title = excluded.title, subtitle = excluded.subtitle, blocks = excluded.blocks, aufgaben = excluded.aufgaben, sort = excluded.sort;
...
from (values
    ...
    ('lv1', '4', 'Am Montag wird in Stuttgart die Bildungs-Didacta eröffnet. Dort werden vor allem Lehrmaterialien vorgestellt. Bei vielen sich um Bildungssoftware. Für ein gelungenes Softwareprojekt wird am der Bildungssoftwarepreis digital vergeben Dabei handelt es sich um die wichtige Auszeichnung für Lehr und Lernprogramm deutschsprachigen Raum Die verzeichnen mit dem digital multimediale Gebote aus, die inhaltlich und formal als ragend und beispielgebend gelten können.', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', '– Des Gallup Instituts hat sich mit Kaffeehausverhaltens der Wiener Ein Vorurteil hat sich dabei bestätigt Kaffeehaus und der Wiener Seine Melange Ergebnisse der Studie 27 der an, zumindest einmal im Monat der Nähe ihrer Wohnung zu gehen. Durchschnittlich 54 Minuten Befragten in ihrem Stamm Café Kundschaft umso länger wird gegessen. Der Grund ein Kaffeehaus wichtiger ist das Plaudern und Freunden. 77 der Befragten Grund für den Besuch im Kaffeehaus', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Das Bienensterben', '[{"key": "A", "text": "ist ein noch ungelöstes Problem."}, {"key": "B", "text": "kann man nur in bestimmten Regionen beobachten."}, {"key": "C", "text": "lässt sich auf eine einzige Ursache zurückführen."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'In vielen Städten', '[{"key": "A", "text": "finden Bienen wenig Futter."}, {"key": "B", "text": "kann man keine Bienen mehr sehen."}, {"key": "C", "text": "schafft man mehr Platz für Bienen."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Werner, Gottlieb und Kessel', '[{"key": "A", "text": "arbeiten in einer Parkanlage in Frankfurt."}, {"key": "B", "text": "forschen über Bienen und ihren Lebensraum."}, {"key": "C", "text": "organisieren eine Veranstaltung über Bienen."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Experten nehmen an, dass', '[{"key": "A", "text": "es in vier Jahren keine Bienen mehr gibt."}, {"key": "B", "text": "man viele Lebensmittel ohne Bienen herstellen kann."}, {"key": "C", "text": "menschliches Leben ohne Bienen nicht möglich ist."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'In Frankfurt gibt es', '[{"key": "A", "text": "schon lange Bienenhalter."}, {"key": "B", "text": "viele kranke Bienenvölker."}, {"key": "C", "text": "zurzeit 60 000 Bienen."}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('hv1', '41', 'Die Sprecherin verbringt ihren Urlaub oft auf dem Land.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Der Sprecher findet Stadturlaub in Wien interessanter als die Berge.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Die Sprecherin meint, dass sich ihre ganze Familie im Urlaub gut erholt.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Die Sprecherin findet den Urlaub in Österreich langweilig.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Die Sprecherin denkt, dass Österreich vor allem für ältere Menschen interessant ist.', null::jsonb, 5, null::jsonb, 4),
...
from (values
    ...
    ('hv1', 'Hörverstehen', 'Hörverstehen, Teil 1', 8, 'Entscheiden Sie, ob die Aussagen richtig oder falsch sind.', 'truefalse', '{"maxPoints": 25, "availablePoints": 25, "missing": 0, "pointsPerItem": 5, "audio": "telc-b1-m13-hv1.mp3", "audioPlays": 2}'::jsonb, 5),
    ('hv2', 'Hörverstehen', 'Hörverstehen, Teil 2', 14, 'Entscheiden Sie, ob die Aussagen richtig oder falsch sind.', 'truefalse', '{"note": "Hinweis: Die Hörtexte sind in der PDF-Vorlage nicht enthalten. Dieser Teil dient zum Wiederholen der Aussagen und zum Vergleich mit der Lösung — nicht zum Hörtraining.", "maxPoints": 25, "availablePoints": 25, "missing": 0, "pointsPerItem": 2.5}'::jsonb, 6),
    ('hv3', 'Hörverstehen', 'Hörverstehen, Teil 3', 8, 'Entscheiden Sie, ob die Aussagen richtig oder falsch sind.', 'truefalse', '{"maxPoints": 25, "availablePoints": 25, "missing": 0, "pointsPerItem": 5, "audio": "telc-b1-m13-hv3.mp3", "audioPlays": 2}'::jsonb, 7),
...
select s.id, v.item_id, v.text, v.options, v.points, v.meta, v.sort
from (values
    ('lv1', '1', '– Das fängt ja gut an: Schon im Kinderzimmer werden Jungs bevorzugt sie bekommen mehr geschenkt als Mädchen. Das ist das Ergebnis einer Untersuchung vom Bundesverband des Spielwaren- Einzelhandels-Bundesweit wurden 6500 Familien nach ihren Schenkgewohnheiten – – befragt. Fast immer wurden für die Söhne auch schon im Babyalter mehr gekauft. Zuständig für die Geschenke sind übrigens meist die Mütter.', null::jsonb, 5, null::jsonb, 0),
    ('lv1', '2', 'In diesem Sommer werden weitere 200 Großstadt-Jugendherbergen auf der ganzen Welt miteinander vernetzt ICYN heißt das Zauberwort International Communication Youth Network. Das System wurde speziell für Jugendherbergen entwickelt. Für nur 15 Euro Jahresgebühr kann man mit der ICYN-Karte weltweit nicht nur Übernachtungen in anderen Herbergen reservieren, sondern auch unbegrenzt im Internet surfen, sogar gratis übers Internet telefonieren, Bahn- und Flugtickets bargeldlos buchen sowie günstige Konzerttickets bekommen.', null::jsonb, 5, null::jsonb, 1),
    ('lv1', '3', 'Ob zu Hause, irgendwo in der Schweiz oder im Ausland: Ferien mit Kindern wollen gut geplant sein. Wo gibt es denn Orte, wo Kinder noch Abenteuer erleben, Hotels oder Wohnungen, in denen sie sich wohl fühlen, wo aber gleichzeitig auch die Eltern auf ihre Rechnung kommen? Ruth Michaela Richter gibt Tipps, verrät Adressen und zeigt Beispiele. Damit werden sogar Städtereisen oder Schlossferien in England interessant.', null::jsonb, 5, null::jsonb, 2),
    ('lv1', '4', 'Die Sehnsucht nach dem Meer ist in der Schweiz groß, vor allem bei der jüngeren Generation. Ein Drittel der Schweizerinnen und Schweizer würde nach einer Umfrage im Tausch für eine Meeresküste die Hälfte der Berge hergeben. Die Zeitschrift mare ließ über 1000 Personen in der Schweiz nach ihrem Verhältnis zum Meer befragen. Rund 42 Prozent der 15-bis 34-Jährigen würden treu dem Motto der Jugendbewegung der 80er Jahre: Nieder mit den Alpen, freie Sicht aufs Mittelmeer den Tausch eingehen. In der Deutschschweiz könnten sich nur 29 Prozent von den Bergen trennen, in der Roman die sind es 37 und im Tessin 43 Prozent.', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', 'Ob für die traditionelle Familie oder für Alleinerziehende: Der Verein für Familienherbergen in Gelsenkirchenbietet schonseit Jahrenpreisgünstige Ferien Über 1100 Zimmer und', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Die Firma Ikea benutzt heute das. Du,', '[{"key": "A", "text": "weil das ein Zeichen für eine Familie Atmosphäre ist."}, {"key": "B", "text": "weil sie mehr jüngere Kunden gewinnen will."}, {"key": "C", "text": "weil so mehr Leute den Verkaufskatalog lesen."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'In der Schweiz', '[{"key": "A", "text": "gilt das Du in Gewerkschaften als Beleidigung."}, {"key": "B", "text": "werden Polizisten nur selten mit Du angesprochen."}, {"key": "C", "text": "wird man bestraft, wenn man zu Beamten Du sagt."}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Eine Untersuchung hat gezeigt,', '[{"key": "A", "text": "dass 14 Prozent der jüngeren Mitarbeiter das Sie vorziehen."}, {"key": "B", "text": "dass besonders jüngere Arbeitskollegen schneller das Du wählen."}, {"key": "C", "text": "dass sich alle Arbeitskollegen gern mit Du anderen würden."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'Durch Kurse können Angestellte', '[{"key": "A", "text": "höfliches Verhalten am Arbeitsplatz lernen."}, {"key": "B", "text": "ihre Stellung im Arbeitsleben verbessern."}, {"key": "C", "text": "neue Trends beim Einrichten des Arbeitsplatzes kennen lernen."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'Im Berufsleben', '[{"key": "A", "text": "bietet immer die ranghöhere Person das Du an."}, {"key": "B", "text": "duzt der ältere Mitarbeiter den jüngeren Chef."}, {"key": "C", "text": "entscheidet immer das Alter, wer das Du anbietet."}]'::jsonb, 5, null::jsonb, 4),
    ('lv3', '11', 'Sie haben von einer Schweizer Schauspielerin gehört und möchten gern einen Film sehen.', null::jsonb, 2.5, null::jsonb, 0),
    ('lv3', '12', 'Sie haben gerade Ihre Ausbildung beendet und suchen eine Stelle an der Rezeption.', null::jsonb, 2.5, null::jsonb, 1),
    ('lv3', '13', 'Sie interessieren sich für Umweltschutz und suchen eine passende Sendung.', null::jsonb, 2.5, null::jsonb, 2),
    ('lv3', '14', 'Ihr Freund, der am Institut für Film und Bild studiert, sucht einen geeigneten Praktikumsplatz.', null::jsonb, 2.5, null::jsonb, 3),
    ...
    ('hv2', '54', 'Der Eintritt in den Spielpark ist zurzeit frei.', null::jsonb, 2.5, null::jsonb, 8),
    ('hv2', '55', 'Die Schlossführung bereitet Kindern und Erwachsenen viel Spaß.', null::jsonb, 2.5, null::jsonb, 9),
    ('hv3', '56', 'Der nächste Zug nach Füssen fährt um 11:56 Uhr.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Die Firma befindet sich in der Bellmondstraße.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Im City-Kino werden im Untergeschoss alte Filme gezeigt.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Das Zugteam bringt Ihnen Südtiroler Käsespezialitäten an Ihren Platz.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Die Großmutter kann heute nicht kommen.', null::jsonb, 5, null::jsonb, 4),
...
from (values
    ...
    ('lv3', '17', 'Sie suchen für drei Vormittage pro Woche eine Stelle als Küchenhilfe.', null::jsonb, 2.5, null::jsonb, 6),
    ('lv3', '18', 'Sie suchen eine leichte Arbeit für abends, um sich noch etwas Geld dazuzuverdienen.', null::jsonb, 2.5, null::jsonb, 7),
    ('lv3', '19', 'Ihre Bekannte möchte als Bedienung in einer Gaststätte arbeiten.', null::jsonb, 2.5, null::jsonb, 8),
    ('lv3', '20', 'Ihre Freunde wollen Familienurlaub machen und suchen ein Angebot, das auch ein Kinderprogramm enthält.', null::jsonb, 2.5, null::jsonb, 9),
    ...
    ('sb1', '22', '… gebucht. Leider entsprach unser Flug überhaupt nicht dem, (22) bei der Buchung am Telefon ausgemacht worden war. …', '[{"key": "A", "text": "das"}, {"key": "B", "text": "was"}, {"key": "C", "text": "wie"}]'::jsonb, 1.5, null::jsonb, 1),
    ('sb1', '23', '… am Telefon ausgemacht worden war. (23) ich ausdrücklich einen Direktflug nach Mumbai bestellt hatte, haben Sie mir …', '[{"key": "A", "text": "Danach"}, {"key": "B", "text": "Obwohl"}, {"key": "C", "text": "Nämlich"}]'::jsonb, 1.5, null::jsonb, 2),
    ('sb1', '24', '… nach Mumbai bestellt hatte, haben Sie mir einen Flug (24) Zwischenstopp in Delhi ausgestellt. Wir mussten eine …', '[{"key": "A", "text": "für"}, {"key": "B", "text": "mit"}, {"key": "C", "text": "zu"}]'::jsonb, 1.5, null::jsonb, 3),
    ('sb1', '25', '… Wir mussten eine Nacht in Delhi verbringen und kamen so (25) einen Tag später als geplant in Mumbai an. Doch damit …', '[{"key": "A", "text": "erst"}, {"key": "B", "text": "nach"}, {"key": "C", "text": "seit"}]'::jsonb, 1.5, null::jsonb, 4),
    ('sb1', '26', '… Doch damit nicht genug. Der Flug war nicht nur anders als vereinbart, (26) auch noch viel teurer. …', '[{"key": "A", "text": "besonders"}, {"key": "B", "text": "sondern"}, {"key": "C", "text": "sonst"}]'::jsonb, 1.5, null::jsonb, 5),
    ('sb1', '27', '… anders als vereinbart, (26) auch noch viel teurer. statt (27) erwarteten 640 Euro kostete der Flug 720 Euro. Ich darf …', '[{"key": "A", "text": "der"}, {"key": "B", "text": "deren"}, {"key": "C", "text": "die"}]'::jsonb, 1.5, null::jsonb, 6),
    ('sb1', '28', '… 640 Euro kostete der Flug 720 Euro. Ich darf Sie daher (28) Rückzahlung der zu viel verrechneten Kosten auf mein …', '[{"key": "A", "text": "für"}, {"key": "B", "text": "um"}, {"key": "C", "text": "zu"}]'::jsonb, 1.5, null::jsonb, 7),
    ('sb1', '29', '… Rückzahlung der zu viel verrechneten Kosten auf mein Konto (29) der Deutschen Bank in Mumbai bitten. …', '[{"key": "A", "text": "an"}, {"key": "B", "text": "bei"}, {"key": "C", "text": "vor"}]'::jsonb, 1.5, null::jsonb, 8),
    ('sb1', '30', '… Ich bitte Sie, die Angelegenheit bald zu klären und (30) dann zu antworten. Mit freundlichen Grüßen Harish Khurana', '[{"key": "A", "text": "mich"}, {"key": "B", "text": "mir"}, {"key": "C", "text": "sich"}]'::jsonb, 1.5, null::jsonb, 9),
    ...
    ('hv1', '41', 'Der Sprecher hätte gern Urlaub wie die anderen Kinder gemacht.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Dem Sprecher hat der Wanderurlaub nicht so gut gefallen.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Die Sprecherin hat die Ferien bei Verwandten verbracht.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Die Sprecherin hat mit ihren Eltern regelmäßig Fahrradausflüge gemacht.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Der Sprecher hat den Urlaub mit den Eltern gemeinsam geplant.', null::jsonb, 5, null::jsonb, 4),
    ('hv2', '46', 'Herr Schütz arbeitet erst seit kurzer Zeit als Taxifahrer', null::jsonb, 2.5, null::jsonb, 0),
    ('hv2', '47', 'In der Kleinstadt hatte Herr Schütz keine Geschäftsleute als Kunden.', null::jsonb, 2.5, null::jsonb, 1),
    ('hv2', '48', 'Herr Schütz hat sich schon einmal in einen Fahrgast verliebt.', null::jsonb, 2.5, null::jsonb, 2),
    ('hv2', '49', 'Die Fahrgäste erzählen viel, weil sie den Taxifahrer nicht kennen.', null::jsonb, 2.5, null::jsonb, 3),
    ...
    ('hv2', '54', 'Herr Schütz hat sich entschieden, nur am Tag Taxi zu fahren.', null::jsonb, 2.5, null::jsonb, 8),
    ('hv2', '55', 'Nach Meinung von Herrn Schütz haben jüngere Taxifahrer weniger Angst, nachts zu an.', null::jsonb, 2.5, null::jsonb, 9),
    ('hv3', '56', 'Der Zug nach Mannheim fährt um 13:14 Uhr ab.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Dr. Hoffmann ist um Urlaub unter der Nummer 957 30 75 zu erreichen.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Sie können den Film das Leben ist schön um 18: 15 Uhr im Central sehen.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Heute Abend beginnt es zu schneien.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Katrin hätte am Dreiundzwanzigsten Zeit.', null::jsonb, 5, null::jsonb, 4),
...
from (values
    ...
    ('lv1', '3', 'Für den einen ist es musikalischer Hochgenuss für den anderen schlicht Lärm. Gemeint ist Musik, die aus Lautsprechen, Radios oder durch Musikinstrumente durch geöffnet Türen und Fenster bei sommerlichen Temperaturen ins Freie dringt. Die Gemeinde weist darauf hin, dass der Mittagsruhe von 13 bis 15 Uhr und nachts von 22 bis 7 Uhr keine musikalische Ruhestörung erfolgen darf. Gartengeräte mit Motoren dürfen montags bis freitags nur von 8 bis 13 und von 15 bis 19 Uhr benutzt werden, an Sonnabenden von 9 bis 13 Uhr. An Sonn - und Feiertagen dürfen die Geräte nicht zum Einsatz kommen.', null::jsonb, 5, null::jsonb, 2),
    ('lv1', '4', '– Das erste deutsche Bücherdorf hat in Mühlbeck/ Fredersdorf (Sachsen Anhalt ) seit Ende September seine Tore geöffnet. In acht Antiquarten warten über 70 000 Bücher aus alleen Bereichen der Literatur auf Interessenten. Das in reizvoller landschaftlicher Umgebung liegende Bücherdorf nahe Bitterfeld - unweit der A19 und des Flughafens Leipzig - ist aus allen Teilen Deutschlands leicht zu erreich. Geöffnet sind die Antiquariate auch am Samstag und Sonntag. In Europa gibt es bereits acht solcher Bücherdörfer in Belgien, Frankreich, Großbritannien, den Niederlanden, Norwegen und der Schweiz. Initiatorin des deutschen Bücherdorfes ist Heidi Dehne (Tel. 03493/4 30 43).', null::jsonb, 5, null::jsonb, 3),
    ('lv1', '5', 'Die Bregenzer Festspiele sind bemüht, die Vorstellungen auch bei zweifelhafter Witterung bzw. leichtem Regen auf der Seebühne abzuhalten, weshalb es zu Verzögerungen des Beginns oder zu Unterbrechungen kommen kann. Sollte die Seeaufführung nicht stattfinden können, wird eine halbszenische Version von Porgy and Bess im Festspielhaus gegeben. Wir empfehlen unseren Gästen , bei unsicherer Wetterlage regenfester Kleidung den Vorzug zu geben und auf Schirme zu verzichten, da diese die Sicht beeinträchtigen. Das Spiel auf dem See wird ohne Pause gespielt. Die Spieldauer beträgt ca.2 Std. 45 Min.', null::jsonb, 5, null::jsonb, 4),
    ('lv2', '6', 'Die Kinderbetreuerinnen kümmern sich um', '[{"key": "A", "text": "Kinder, die auf dem Flughafen warten müssen."}, {"key": "B", "text": "Kinder, die im Flugzeug krank wurden.."}, {"key": "C", "text": "Kinder, die ohne Eltern fliegen müssen."}]'::jsonb, 5, null::jsonb, 0),
    ('lv2', '7', 'Die Flughafen Zürich-Kloten ist besonders familienfreundlich,', '[{"key": "A", "text": "seit Alice Martin dort arbeitet."}, {"key": "B", "text": "weil die Wartezeit kürzer ist als auf anderen Flughäfen."}, {"key": "C", "text": "weil es Räume gibt, in denen Kinder spielen können"}]'::jsonb, 5, null::jsonb, 1),
    ('lv2', '8', 'Frau Alice Martin hat eine Ausbildung als', '[{"key": "A", "text": "Flugbegleiterin."}, {"key": "B", "text": "Kinderschwester."}, {"key": "C", "text": "Pilotin."}]'::jsonb, 5, null::jsonb, 2),
    ('lv2', '9', 'In den Aufenthaltsräumen spielen die Kinder', '[{"key": "A", "text": "am liebsten mit 18 Betreuerinnen."}, {"key": "B", "text": "am liebsten mit Alice Martin."}, {"key": "C", "text": "auch mit Kindern anderer Kulturen und Sprachen."}]'::jsonb, 5, null::jsonb, 3),
    ('lv2', '10', 'Frau Alice Martin findet', '[{"key": "A", "text": "die Arbeit auf dem Flughafen interessant und abwechslungsreich."}, {"key": "B", "text": "die Arbeit auf dem Flughafen nicht so vielseitig wie die Arbeit im Spital."}, {"key": "C", "text": "die Kontakte zu den Kindern auf dem Flughafen sehr intensiv."}]'::jsonb, 5, null::jsonb, 4),
    ...
    ('sb1', '24', '… Sie an einem Preisausschreiben teilnehmen. Senden Sie uns (24) das beigefügte Antwortschreiben zurück und bestellen Sie …', '[{"key": "A", "text": "einfach"}, {"key": "B", "text": "immer"}, {"key": "C", "text": "noch"}]'::jsonb, 1.5, null::jsonb, 3),
    ('sb1', '25', '… – das Buch des Monats. Sie erhalten dieses Buch mit (25) versprechen, es nach 10 Tage zurückgeben zu können, …', '[{"key": "A", "text": "unsere"}, {"key": "B", "text": "unserem"}, {"key": "C", "text": "unseren"}]'::jsonb, 1.5, null::jsonb, 4),
    ('sb1', '26', '… Ohne irgendetwas zu zahlen! Behalten Sie das Buch, was wir (26) hoffen, zahlen Sie nur 50 Prozent des sonst …', '[{"key": "A", "text": "natürlich"}, {"key": "B", "text": "schön"}, {"key": "C", "text": "viele"}]'::jsonb, 1.5, null::jsonb, 5),
    ('sb1', '27', '… Gleichzeitig nehmen Sie an einem Preisausschreiben (27). Bitte bedanken Sie: sollte Ihre Kundennummer(28) den …', '[{"key": "A", "text": "mit"}, {"key": "B", "text": "teil"}, {"key": "C", "text": "zu"}]'::jsonb, 1.5, null::jsonb, 6),
    ('sb1', '28', '… (27). Bitte bedanken Sie: sollte Ihre Kundennummer(28) den richtigen Zahlen sein, haben Sie die Chance, ein Auto …', '[{"key": "A", "text": "unter"}, {"key": "B", "text": "neben"}, {"key": "C", "text": "vor"}]'::jsonb, 1.5, null::jsonb, 7),
    ('sb1', '29', '… ein Auto eine Reise und viele weitere Preise zu erhalten. Antworten Sie (29) noch diese Woche! Dann haben Sie in …', '[{"key": "A", "text": "bald"}, {"key": "B", "text": "bereits"}, {"key": "C", "text": "unbedingt"}]'::jsonb, 1.5, null::jsonb, 8),
    ('sb1', '30', '… der kommenden vier Wochen antworten, nehmen Sie immer(30) an unserer Gewinnverteilung teil – vorausgesetzt, Sie …', '[{"key": "A", "text": "noch"}, {"key": "B", "text": "schon"}, {"key": "C", "text": "schnell"}]'::jsonb, 1.5, null::jsonb, 9),
    ('sb2', '31', '… der Neuen Presse gelesen und bin an dem Filmprojekt sehr (31). ich war schon (32) für einige Wochen im Ausland. Vor …', null::jsonb, 1.5, null::jsonb, 0),
    ('sb2', '32', '… und bin an dem Filmprojekt sehr (31). ich war schon (32) für einige Wochen im Ausland. Vor allem im Sommer habe …', null::jsonb, 1.5, null::jsonb, 1),
    ('sb2', '33', '… Sprachkurse besucht. Länger als ein halbes Jahr habe ich (33) einmal im Ausland gelebt, und zwar (34) zwei Jahren. Mein …', null::jsonb, 1.5, null::jsonb, 2),
    ...
    ('sb2', '39', '… leben wollen, sehr interessant sein könnten, und ich (39) gerne auch vor der Kamera darüber erzählen. (40) Sie noch …', null::jsonb, 1.5, null::jsonb, 8),
    ('sb2', '40', '… und ich (39) gerne auch vor der Kamera darüber erzählen. (40) Sie noch weitere Fragen an mich haben, können Sie mich …', null::jsonb, 1.5, null::jsonb, 9),
    ('hv1', '41', 'Die Sprecherin ist dagegen, dass Kinder so früh eine Fremdsprache lernen.', null::jsonb, 5, null::jsonb, 0),
    ('hv1', '42', 'Die Sprecherin meint, dass das frühe Lernen einer Fremdsprache für viele Kinder Nachteile hat.', null::jsonb, 5, null::jsonb, 1),
    ('hv1', '43', 'Der Sprecher findet es schade, dass er im Kindergarten keine Fremdsprache lernen konnte.', null::jsonb, 5, null::jsonb, 2),
    ('hv1', '44', 'Die Sprecherin meint, dass das Fremdsprachenlernen erst in der Schule beginnen sollte.', null::jsonb, 5, null::jsonb, 3),
    ('hv1', '45', 'Der Sprecher ist dagegen, dass Kinder schon früh Fremdsprache lernen.', null::jsonb, 5, null::jsonb, 4),
    ...
    ('hv2', '55', 'In Zukunft betreut die Spitex auch die alten Menschen in Deutschland.', null::jsonb, 2.5, null::jsonb, 9),
    ('hv3', '56', 'Der Fahrer des Wagens mit dem Kennzeichen HB-D 256 soll ins Erdgeschoss kommen.', null::jsonb, 5, null::jsonb, 0),
    ('hv3', '57', 'Die Firma liefert das bestellte Sofa am Dienstagnachmittag zwischen drei und sechs Uhr liefern.', null::jsonb, 5, null::jsonb, 1),
    ('hv3', '58', 'Der Gasthof Lindner liegt neben einer Tankstelle.', null::jsonb, 5, null::jsonb, 2),
    ('hv3', '59', 'Der Film Komiker wird mehrmals am Tag gezeigt.', null::jsonb, 5, null::jsonb, 3),
    ('hv3', '60', 'Für den Abend wird kein Regen erwartet.', null::jsonb, 5, null::jsonb, 4),
