...
from (values
    ('lv1', 'Lesen', 'Lesen, Teil 1', 10, 'Lesen Sie die beiden Texte und die Aufgaben 1 bis 5. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "Einladung zum Jazz-Konzert", "b": true}, {"t": "Liebe Frau Dehner,", "b": false}, {"t": "vielen Dank für die Einladung zu Ihrem Jazz-Konzert. Ich komme gern und ich freue mich sehr auf das Konzert.", "b": false}, {"t": "Ich danke Ihnen auch, dass ich in Ihrem Gästezimmer schlafen kann und kein Hotel suchen muss. Mein Zug kommt schon um circa 16 Uhr an.", "b": false}, {"t": "Kann ich Ihnen am Nachmittag dann vor dem Konzert etwas helfen?", "b": false}, {"t": "Bis bald und herzliche Grüße", "b": false}, {"t": "Winfried Beck", "b": false}]}, {"paragraphs": [{"t": "Betreff: Neuer Arbeitsplan", "b": true}, {"t": "Liebe Frau Jakobs,", "b": false}, {"t": "ich komme heute, Dienstag, noch nicht aus Berlin zurück.", "b": false}, {"t": "Ich habe morgen ein Gespräch mit dem Kunden Maybach. Der ist ganz wichtig für uns. Und am Donnerstag habe ich zwei weitere neue Termine.", "b": false}, {"t": "Aber am Freitag bin ich ab 8 Uhr wieder im Büro.", "b": false}, {"t": "Bitte machen Sie mir für 11 Uhr einen Termin mit Dr. Falk.", "b": false}, {"t": "Vielen Dank und herzliche Grüße", "b": false}, {"t": "Helga Stein", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ...
    ('lv3', 'Lesen', 'Lesen, Teil 3', 5, 'Lesen Sie die Texte und die Aufgaben 11 bis 15. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "Vor einem Blumenladen", "b": true}, {"t": "Neu! Neu! Neu! Neu! Neu!", "b": false}, {"t": "Liebe Kunden!", "b": false}, {"t": "Ab sofort haben wir auch sonntags von 9-12 Uhr für Sie geöffnet!", "b": false}]}, {"paragraphs": [{"t": "Im Restaurant", "b": true}, {"t": "Liebe Gäste,", "b": false}, {"t": "im nächsten Monat kocht bei uns ein Koch aus Kalkutta indische Spezialitäten.", "b": false}, {"t": "Wir freuen uns auf Ihren Besuch.", "b": false}]}, {"paragraphs": [{"t": "Bei der Straßenbahn", "b": true}, {"t": "Linie 8:", "b": false}, {"t": "Ab 15. nur bis Hauptbahnhof.", "b": false}, {"t": "Zur Weiterfahrt nach Huchting: Linie 1 oder Bus Nr. 53.", "b": false}]}, {"paragraphs": [{"t": "An einer Haustür", "b": true}, {"t": "Sehr geehrte Interessenten,", "b": false}, {"t": "es gibt leider keine Besichtigungen mehr. Die 3-Zimmer-Wohnung im 3. Stock ist schon vermietet.", "b": false}]}, {"paragraphs": [{"t": "Im Bahnhof", "b": true}, {"t": "Sehr geehrte Fahrgäste!", "b": false}, {"t": "Ab 22 Uhr sind unsere Schalter geschlossen. Fahrkarten bekommen Sie dann an unseren Automaten.", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
...
from (values
    ...
    ('lv1', '2', 'Herr Beck bietet Frau Dehner seine Hilfe an.', null::jsonb, 1, null::jsonb, 1),
    ...
    ('lv3', '11', 'Am Sonntagvormittag bekommen Sie hier Blumen.', null::jsonb, 1, null::jsonb, 0),
    ('lv3', '12', 'Jeden Montag bietet das Restaurant indisches Essen an.', null::jsonb, 1, null::jsonb, 1),
    ('lv3', '13', 'Es ist der 2. Mai, 21 Uhr. Sie können jetzt nicht zum Hauptbahnhof fahren.', null::jsonb, 1, null::jsonb, 2),
    ('lv3', '14', 'Sie können die Wohnung nicht besichtigen.', null::jsonb, 1, null::jsonb, 3),
...
select t.id, v.section_id, v.grp, v.title, v.minutes, v.instruction, v.format, v.config, v.sort
from (values
    ('lv1', 'Lesen', 'Lesen, Teil 1', 10, 'Lesen Sie die beiden Texte und die Aufgaben 1 bis 5. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "Hallo Li,", "b": true}, {"t": "danke für deine Mail. Dein Zug kommt hier in Hannover um 12.36 Uhr an. Ich bin ab 12.15 Uhr im Hauptbahnhof und warte auf dich vor der Auskunft.", "b": false}, {"t": "Du kannst mich den ganzen Vormittag auf meinem Handy (++49 173 62 205 59) erreichen.", "b": false}, {"t": "Deine Karin", "b": false}]}, {"paragraphs": [{"t": "Liebe Carmen,", "b": true}, {"t": "am kommenden Sonntag habe ich Geburtstag.", "b": false}, {"t": "Ich möchte gerne mit dir feiern und lade dich herzlich zu meiner Party am Samstagabend ein.", "b": false}, {"t": "Wir fangen um 21 Uhr an. Ist das okay für dich?", "b": false}, {"t": "Es werden viele Leute da sein, die du auch kennst.", "b": false}, {"t": "Kannst du vielleicht einen Salat mitbringen? Und vergiss bitte nicht einen Pullover oder eine Jacke!", "b": false}, {"t": "Wir wollen nämlich draußen im Garten feiern.", "b": false}, {"t": "Ich freue mich sehr auf dich!", "b": false}, {"t": "Bis zum Wochenende", "b": false}, {"t": "Ralf", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Lesen Sie die Texte und die Aufgaben 6 bis 10. Wo finden Sie Informationen? Kreuzen Sie an: a oder b.', 'mc', '{"maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 1),
    ('lv3', 'Lesen', 'Lesen, Teil 3', 5, 'Lesen Sie die Texte und die Aufgaben 11 bis 15. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "In der Sprachschule", "b": true}, {"t": "In der 10-Uhr-Pause bekommen Sie an der Rezeption ein Frühstückspaket:", "b": false}, {"t": "Belegte Brötchen und Getränke für 2 Euro.", "b": false}]}, {"paragraphs": [{"t": "An der Post", "b": true}, {"t": "Öffnungszeiten:", "b": false}, {"t": "montags – freitags: 8.00 – 12.00 und 13.00 – 18.00", "b": false}, {"t": "samstags: 8.00 – 12.00", "b": false}]}, {"paragraphs": [{"t": "Am Bahnhof", "b": true}, {"t": "Auf dem gesamten Bahnhof ist das Rauchen verboten.", "b": false}]}, {"paragraphs": [{"t": "Eingang Restaurant", "b": true}, {"t": "Heute im Bavaria:", "b": false}, {"t": "Bayerischer Abend: Brezeln, Weißwürste, Sauerkraut.", "b": false}, {"t": "Volksmusik, ab 20 Uhr Tanz.", "b": false}]}, {"paragraphs": [{"t": "An der Haltestelle", "b": true}, {"t": "In der Neujahrsnacht:", "b": false}, {"t": "Busverkehr bis 23.00 Uhr und von 1.00 Uhr bis 5.00 Uhr alle 30 Minuten.", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
...
from (values
    ...
    ('lv1', '2', 'Karin wartet den ganzen Vormittag vor der Auskunft.', null::jsonb, 1, null::jsonb, 1),
    ...
    ('lv3', '11', 'In der Sprachschule können Sie etwas zu essen kaufen.', null::jsonb, 1, null::jsonb, 0),
    ('lv3', '12', 'Es ist Samstagnachmittag. Sie können auf der Post Briefmarken kaufen.', null::jsonb, 1, null::jsonb, 1),
    ('lv3', '13', 'Sie können hier Zigaretten rauchen.', null::jsonb, 1, null::jsonb, 2),
    ('lv3', '14', 'Heute Abend können Sie in diesem Restaurant tanzen.', null::jsonb, 1, null::jsonb, 3),
...
select t.id, v.section_id, v.grp, v.title, v.minutes, v.instruction, v.format, v.config, v.sort
from (values
    ('lv1', 'Lesen', 'Lesen, Teil 1', 10, 'Lesen Sie die beiden Texte und die Aufgaben 1 bis 5. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "Liebe Nora", "b": true}, {"t": "Liebe Nora,", "b": false}, {"t": "viele Grüße aus Weimar! Ich habe ein schönes Zimmer im Hotel Drei Kronen ganz in der Nähe vom Zentrum. Die Arbeit an der Universität ist sehr interessant, aber ich muss viel arbeiten. Am Abend habe ich aber frei. Wollen wir uns morgen um 19:30 Uhr im Restaurant „Zum Schwan“ treffen?", "b": false}, {"t": "Bis morgen", "b": false}, {"t": "Renate", "b": false}]}, {"paragraphs": [{"t": "Sommerausflug Sportsfreunde", "b": true}, {"t": "Liebe Sportsfreunde vom Verein 1896,", "b": false}, {"t": "auch dieses Jahr wollen wir wieder unseren Sommerausflug machen. Wir fahren mit dem Bus an den Dümmer See. Dort wollen wir wandern und in einem netten Restaurant zu Mittag essen.", "b": false}, {"t": "Abfahrt ist am 27. Juni um 9 Uhr vor dem Vereinshaus. Die Busfahrt kostet 10 Euro pro Person; das Essen und die Getränke zahlt jeder allein.", "b": false}, {"t": "Liebe Freunde, bitte meldet euch bald an!", "b": false}, {"t": "Bis dann", "b": false}, {"t": "Heinz Paschke", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Lesen Sie die Texte und die Aufgaben 6 bis 10. Wo finden Sie Informationen? Kreuzen Sie an: a oder b.', 'mc', '{"maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 1),
    ('lv3', 'Lesen', 'Lesen, Teil 3', 5, 'Lesen Sie die Texte und die Aufgaben 11 bis 15. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "Am Fahrkartenautomaten", "b": true}, {"t": "Bayern-Ticket:", "b": false}, {"t": "Ein Tag. Fünf Personen. 29 Euro.", "b": false}, {"t": "Montag und Freitag ab 9 Uhr,", "b": false}, {"t": "am Wochenende von 6 bis 24 Uhr.", "b": false}]}, {"paragraphs": [{"t": "Im Hotelzimmer", "b": true}, {"t": "Liebe Gäste,", "b": false}, {"t": "ab 21 Uhr ist die Haustür geschlossen.", "b": false}, {"t": "Bitte nehmen Sie Ihren Zimmerschlüssel mit,", "b": false}, {"t": "er ist auch der Hausschlüssel!", "b": false}]}, {"paragraphs": [{"t": "Eingang Restaurant", "b": true}, {"t": "Wir haben für Sie täglich", "b": false}, {"t": "von 11.30 bis 15.00 Uhr und", "b": false}, {"t": "von 18.00 bis 22.00 Uhr", "b": false}, {"t": "geöffnet, auch am Wochenende", "b": false}, {"t": "und an Feiertagen.", "b": false}]}, {"paragraphs": [{"t": "Im Kultur-Verein", "b": true}, {"t": "Ab sofort:", "b": false}, {"t": "Jeden Samstag um 20 Uhr Filmabend!", "b": false}, {"t": "Am 3.5.: „Im Juli“ von Fatih Akın.", "b": false}, {"t": "Eintritt 2 Euro.", "b": false}]}, {"paragraphs": [{"t": "Im Bahnhof", "b": true}, {"t": "Kartenverkauf an Schalter 1 bis 3.", "b": false}, {"t": "Informationen an Schalter 4.", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
...
from (values
    ...
    ('lv1', '2', 'Sie möchte am Abend mit Nora zusammen essen.', null::jsonb, 1, null::jsonb, 1),
    ...
    ('lv3', '11', 'Am Samstag können Sie und Ihre Freunde mit dem Ticket für 29 Euro fahren.', null::jsonb, 1, null::jsonb, 0),
    ('lv3', '12', 'Nach 22 Uhr kommen Sie nicht mehr ins Hotel.', null::jsonb, 1, null::jsonb, 1),
    ('lv3', '13', 'Am Sonntagmittag können Sie in diesem Restaurant essen.', null::jsonb, 1, null::jsonb, 2),
    ('lv3', '14', 'Man kann diesen Samstagabend einen Film sehen.', null::jsonb, 1, null::jsonb, 3),
...
select t.id, v.section_id, v.grp, v.title, v.minutes, v.instruction, v.format, v.config, v.sort
from (values
    ('lv1', 'Lesen', 'Lesen, Teil 1', 10, 'Lesen Sie die beiden Texte und die Aufgaben 1 bis 5. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "Nachricht von Andrea", "b": true}, {"t": "Hallo Julia,", "b": false}, {"t": "ich muss heute länger im Büro bleiben. Ich weiß noch nicht, wie lange. Aber um 20 Uhr kann ich nicht beim Kino sein. Können wir morgen Abend ins Kino gehen? Auch um 20 Uhr? Ist das ok für dich?", "b": false}, {"t": "Tut mir leid ...", "b": false}, {"t": "Liebe Grüße", "b": false}, {"t": "Andrea", "b": false}]}, {"paragraphs": [{"t": "Notiz von Julia Berger", "b": true}, {"t": "Liebe Frau Schmidt,", "b": false}, {"t": "wir fahren doch nächsten Montag in den Urlaub, in die Türkei. Können Sie bitte nach der Post und den Blumen sehen? Als Dankeschön möchte ich Sie gerne zu einem Essen bei mir zu Hause einladen. Wann haben Sie Zeit? Dann gebe ich Ihnen auch die Wohnungsschlüssel.", "b": false}, {"t": "Danke", "b": false}, {"t": "Julia Berger", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Lesen Sie die Texte und die Aufgaben 6 bis 10. Wo finden Sie Informationen? Kreuzen Sie an: a oder b.', 'mc', '{"maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 1),
    ('lv3', 'Lesen', 'Lesen, Teil 3', 5, 'Lesen Sie die Texte und die Aufgaben 11 bis 15. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "In der Schule", "b": true}, {"t": "Schulfest am nächsten Samstag.", "b": false}, {"t": "Alle Schülerinnen, Schüler und Eltern sind eingeladen.", "b": false}, {"t": "Kaffee und Kuchen gibt es in der Cafeteria.", "b": false}, {"t": "Abends Disco", "b": false}]}, {"paragraphs": [{"t": "Am Busbahnhof", "b": true}, {"t": "Ab Januar günstige Busreisen in ganz Deutschland.", "b": false}, {"t": "Informationen am Busbahnhof, Schalter 12", "b": false}]}, {"paragraphs": [{"t": "Vor dem Ticketshop", "b": true}, {"t": "Das Konzert der Toten Hosen in der Stadthalle ist ausverkauft.", "b": false}]}, {"paragraphs": [{"t": "Im Internet", "b": true}, {"t": "Hessenticket der Deutschen Bahn", "b": false}, {"t": "Bis zu 5 Personen können an einem Tag durch ganz Hessen mit Bus oder Bahn fahren.", "b": false}, {"t": "Für nur 31,- Euro.", "b": false}]}, {"paragraphs": [{"t": "Beim Arzt", "b": true}, {"t": "In der Praxis sind Handys verboten.", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
...
from (values
    ...
    ('lv1', '2', 'Sie möchte Julia morgen treffen.', null::jsonb, 1, null::jsonb, 1),
    ...
    ('lv3', '11', 'In der Schule können Sie am Samstag tanzen.', null::jsonb, 1, null::jsonb, 0),
    ('lv3', '12', 'Im Januar gibt es Busfahrten nach Deutschland.', null::jsonb, 1, null::jsonb, 1),
    ('lv3', '13', 'Es gibt keine Karten mehr.', null::jsonb, 1, null::jsonb, 2),
    ('lv3', '14', 'Das Hessenticket gibt es nur für Gruppen ab 5 Personen.', null::jsonb, 1, null::jsonb, 3),
...
select t.id, v.section_id, v.grp, v.title, v.minutes, v.instruction, v.format, v.config, v.sort
from (values
    ('lv1', 'Lesen', 'Lesen, Teil 1', 10, 'Lesen Sie die beiden Texte und die Aufgaben 1 bis 5. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "Entschuldigung für die Schule", "b": true}, {"t": "Sehr geehrte Frau Helbich,", "b": false}, {"t": "ich möchte meine Tochter Andrea entschuldigen. Sie hat Fieber und kann nicht zur Schule kommen. Nächste Woche kann sie wieder kommen. Können Sie mir bitte die Hausaufgaben sagen – am besten per Mail?", "b": false}, {"t": "Danke und viele Grüße", "b": false}, {"t": "Julia Schmidt", "b": false}]}, {"paragraphs": [{"t": "Urlaubsplanung an der Nordsee", "b": true}, {"t": "Hallo Robert,", "b": false}, {"t": "wie geht es dir? Du, Robert, wir möchten nächsten Sommer an der Nordsee Urlaub machen. Du warst doch letzten Sommer dort. Kannst du mir ein paar Tipps geben, kannst du mir etwas empfehlen? Vielleicht fahren wir auch ein paar Tage nach Hamburg. Kennst du gute Hotels? Welche Sehenswürdigkeiten gibt es dort?", "b": false}, {"t": "Wir können uns ja bald mal wieder treffen. Dann lade ich dich zu einem Glas Wein ein.", "b": false}, {"t": "Viele Grüße", "b": false}, {"t": "Fabian", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 0),
    ('lv2', 'Lesen', 'Lesen, Teil 2', 10, 'Lesen Sie die Texte und die Aufgaben 6 bis 10. Wo finden Sie Informationen? Kreuzen Sie an: a oder b.', 'mc', '{"maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 1),
    ('lv3', 'Lesen', 'Lesen, Teil 3', 5, 'Lesen Sie die Texte und die Aufgaben 11 bis 15. Kreuzen Sie an: Richtig oder Falsch.', 'truefalse', '{"passages": [{"paragraphs": [{"t": "In der Sprachschule", "b": true}, {"t": "Griechischlehrer/in gesucht.", "b": false}, {"t": "Die Volkshochschule sucht ab sofort KursleiterInnen für Griechischkurse auf allen Stufen.", "b": false}]}, {"paragraphs": [{"t": "An der Post", "b": true}, {"t": "Räder abstellen verboten.", "b": false}]}, {"paragraphs": [{"t": "Beim Zahnarzt", "b": true}, {"t": "Dr. Kern – Sprechstunde", "b": false}, {"t": "Mo–Di, Do–Fr 9–12 Uhr, 14–18 Uhr", "b": false}, {"t": "Mi 9–12 Uhr.", "b": false}]}, {"paragraphs": [{"t": "Im Kaufhaus", "b": true}, {"t": "Weihnachten steht vor der Tür.", "b": false}, {"t": "Haben Sie schon alle Geschenke?", "b": false}, {"t": "An den vier Sonntagen vor Weihnachten haben wir für Sie geöffnet.", "b": false}]}, {"paragraphs": [{"t": "An einer Videothek", "b": true}, {"t": "Videothek SATURN", "b": false}, {"t": "Neueröffnung am 1. Juni.", "b": false}, {"t": "In zwei Wochen können Sie in der Heidestraße DVDs kaufen und ausleihen.", "b": false}]}], "maxPoints": 5, "availablePoints": 5, "missing": 0, "pointsPerItem": 1}'::jsonb, 2),
...
from (values
    ...
    ('lv1', '2', 'Frau Schmidt möchte die Hausaufgaben wissen.', null::jsonb, 1, null::jsonb, 1),
    ...
    ('lv3', '11', 'Hier gibt es Sprachkurse für Griechen.', null::jsonb, 1, null::jsonb, 0),
    ('lv3', '12', 'Sie dürfen hier keine Räder abstellen.', null::jsonb, 1, null::jsonb, 1),
    ('lv3', '13', 'Am Vormittag ist die Praxis immer geöffnet.', null::jsonb, 1, null::jsonb, 2),
    ('lv3', '14', 'Am Sonntag vor Weihnachten können Sie einkaufen.', null::jsonb, 1, null::jsonb, 3),
